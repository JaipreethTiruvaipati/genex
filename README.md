...
## 📖 About
GeneTrust is an integrated platform that addresses critical challenges in CRISPR-based gene editing—specifically, the difficulty in designing effective guide RNAs, the sensitivity of experiments to lab conditions, and the need for secure, traceable data management. The platform empowers researchers, biotech professionals, and students with tools that significantly enhance the efficiency, reliability, and trustworthiness of gene editing workflows.

## 🎯 Key Capabilities

### AI-Powered Prediction
- Fine-tuned **DNABERT model** for optimal guide RNA design
- **Groq API integration** for rapid inference and AI-driven explanations
- Tokenization and embedding strategies optimized for biological sequences
- Real-time prediction with low latency using Language Processing Units (LPUs)

### IoT-Driven Lab Monitoring
- Real-time environmental sensor integration for lab condition monitoring
- Continuous data synchronization between sensors and backend
- Anomaly detection for maintaining optimal experimental conditions
- Critical for ensuring experimental reproducibility

### Blockchain Security
- **Base blockchain** integration for immutable data provenance
- Smart contracts for sample tracking and audit trails
- Granular access control and workflow automation
- Transparent, auditable trail for genomic data and experimental outcomes

### System Architecture
The platform integrates multiple technologies into a cohesive system:
- Python-based ML service for gene prediction (DNABERT model)
- Node.js/Express backend for API orchestration
- Next.js frontend with real-time updates via Socket.IO
- FastAPI bridge for Python-Node.js communication
- MongoDB for data persistence
- Web3 integration via Wagmi and OnchainKit
...
- **Web3:** Wagmi, Viem, OnchainKit, RainbowKit

### Backend
- **Runtime:** Node.js
- **Framework:** Express

### 🧬 AI-Enhanced CRISPR Prediction
- Submit DNA sequences to the DNABERT model
- Receive predictions with confidence scores
- Detailed AI-driven explanations powered by Groq
- Support for batch processing and sequence analysis

### 📊 Real-Time Lab Monitoring Dashboard
- Visualize streaming data from lab instruments
- Temperature, humidity, and environmental sensors
- Anomaly detection and alerting
- Historical data analysis and trends

### 💬 Integrated AI Assistant Hub
- Chat interface powered by Groq LLMs
- Context-aware assistance for experimental design
- Troubleshooting and methodology recommendations
- Natural language query interface

### 🔐 Web3 Wallet Integration
- Onchain identity via Base Smart Wallets
- Secure authentication using RainbowKit and Wagmi
- Transaction signing and verification
- Decentralized data provenance tracking

### 🏗️ Modular Architecture
- Microservices-based design
- Clear separation of concerns (ML, Backend, Frontend)
- Independent scaling and deployment
- RESTful API design with Socket.IO for real-time features
...
2. **Start the Gene Predictor Server**
   ...
   bash run_serv& Credits

### APIs & Services
- [Groq Cloud API](https://console.groq.com) - AI inference and chat
- [WalletConnect](https://docs.walletconnect.com) - Web3 wallet connectivity
- [Base](https://base.org) - Layer 2 blockchain network
- [MongoDB Atlas](https://www.mongodb.com/atlas) - Database hosting

### Open Source Libraries
- **Frontend:** Next.js, React, Tailwind CSS, Shadcn/ui, Socket.IO Client, Recharts, Framer Motion
- **Backend:** Express, Mongoose, Socket.IO, FastAPI
- **ML/AI:** DNABERT, PyTorch, Transformers, Groq SDK
- **Web3:** Wagmi, Viem, OnchainKit, RainbowKit
